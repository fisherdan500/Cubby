...
export const operation = {
  schemaVersion: 1,
  id: "package_command:scripts/scripts.vitest.config.ts",
  ownerModule: "scripts/scripts.vitest.config.ts",
  ownerKind: "package_command",
  bindings: [
    { kind: "package_script", symbol: "test:scripts", target: "package.json#scripts.test:scripts" }
  ],
