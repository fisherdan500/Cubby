...
export const operation = {
  schemaVersion: 1,
  id: "package_command:scripts/quick-start.acceptance-rehearsal.ts",
  ownerModule: "scripts/quick-start.acceptance-rehearsal.ts",
  ownerKind: "package_command",
  bindings: [
    {
      kind: "package_script",
      symbol: "verify:quick-start",
      target: "package.json#scripts.verify:quick-start"
    }
  ],
