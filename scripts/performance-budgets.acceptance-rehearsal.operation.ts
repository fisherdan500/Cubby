...
export const operation = {
  schemaVersion: 1,
  id: "package_command:scripts/performance-budgets.acceptance-rehearsal.ts",
  ownerModule: "scripts/performance-budgets.acceptance-rehearsal.ts",
  ownerKind: "package_command",
  bindings: [
    {
      kind: "package_script",
      symbol: "verify:performance-1y",
      target: "package.json#scripts.verify:performance-1y"
    },
    {
      kind: "package_script",
