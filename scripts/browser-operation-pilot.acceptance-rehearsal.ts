...
export function runBrowserOperationPilotAcceptance() {
  ...
  try {
    ...
    sql('SELECT COUNT(*) FROM "_prisma_migrations"', "30");
    ...
    sql("INSERT INTO \"BrowserOperationBinding\" (\"id\",\"sessionId\",\"actorUserId\",\"actorMemberId\",\"householdId\",\"operationId\",\"operationKey\",\"intentFingerprint\",\"babyId\",\"expiresAt\",\"updatedAt\") VALUES ('bind1','session-retained','u1','m1','h1','bmo_0123456789abcdefghjkmnpqrs','calendar_event.create','fp1','b1',NOW() + INTERVAL '30 minutes',NOW());");
    sql("INSERT INTO \"BrowserMutationOperation\" (\"bindingId\",\"householdId\",\"operationId\",\"operationKey\",\"actorUserId\",\"actorMemberId\",\"intentFingerprint\",\"babyId\",\"status\",\"outcomeVersion\",\"outcomeKind\",\"outcomeCode\",\"outcomeSnapshot\",\"terminalAt\",\"updatedAt\") VALUES ('bind1','h1','bmo_0123456789abcdefghjkmnpqrs','calendar_event.create','u1','m1','fp1','b1','completed',1,'created','calendar_event_created','{}',NOW(),NOW());");
