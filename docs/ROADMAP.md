...
- Status: active; P0, P1.1, P1-2, and P1-7 have accepted merged evidence. P1-4 is selected only for a bounded read-only exact-main delta reconciliation; P1-1, P1-3, P1-5, and P1-6 remain partial, and P1-8 remains blocked. Post-merge exact-head review, deployment, cutover, and cleanup remain separate gates.
- Priority: high
