...
/**
 * Erases removed attachments once their thirty days are up, uploads nothing claimed within a day
 * (DEC-PROD-146), and backup uploads an interrupted restore left behind. Failures are logged by code
 * only: paths and names never reach the log.
 */
