...
export const operation = {
  schemaVersion: 1,
  id: "client_binding:src/components/browser-operation-recovery.tsx",
  ownerModule: "src/components/browser-operation-recovery.tsx",
  ownerKind: "client_binding",
  bindings: [{ kind: "global_fetch", symbol: "fetch[1]", target: "globalThis.fetch" }],
