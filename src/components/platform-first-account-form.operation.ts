...
export const operation = {
  schemaVersion: 1,
  id: "client_binding:src/components/platform-first-account-form.tsx",
  ownerModule: "src/components/platform-first-account-form.tsx",
  ownerKind: "client_binding",
  bindings: [
    {
      kind: "form_action",
      symbol: "submit",
      target: "src/components/platform-first-account-form.tsx#submit"
    },
    {
      kind: "global_fetch",
      symbol: "fetch[1]",
