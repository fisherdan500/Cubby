...
export const operation = {
  schemaVersion: 1,
  id: "server_loader:src/app/app/settings/security-history/page.tsx",
  ownerModule: "src/app/app/settings/security-history/page.tsx",
  ownerKind: "server_loader",
  bindings: [{ kind: "server_value_import", symbol: "requireUserPage", target: "src/server/auth/session.ts#requireUserPage" }],
