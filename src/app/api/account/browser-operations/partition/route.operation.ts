...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/account/browser-operations/partition/route.ts",
  ownerModule: "src/app/api/account/browser-operations/partition/route.ts",
  ownerKind: "api_route",
  bindings: [
    {
      kind: "route_method",
      symbol: "GET",
      target: "src/app/api/account/browser-operations/partition/route.ts#GET"
    }
  ],
