...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/account/appearance/route.ts",
  ownerModule: "src/app/api/account/appearance/route.ts",
  ownerKind: "api_route",
  bindings: [
    { kind: "route_method", symbol: "GET", target: "src/app/api/account/appearance/route.ts#GET" },
    { kind: "route_method", symbol: "PATCH", target: "src/app/api/account/appearance/route.ts#PATCH" },
  ],
