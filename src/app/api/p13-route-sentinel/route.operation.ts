...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/p13-route-sentinel/route.ts",
  ownerModule: "src/app/api/p13-route-sentinel/route.ts",
  ownerKind: "api_route",
  bindings: [
    {
      kind: "route_method",
      symbol: "GET",
      target: "src/app/api/p13-route-sentinel/route.ts#GET"
    }
  ],
