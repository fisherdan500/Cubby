...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/platform/test-email/route.ts",
  ownerModule: "src/app/api/platform/test-email/route.ts",
  ownerKind: "api_route",
  bindings: [
    { kind: "route_method", symbol: "POST", target: "src/app/api/platform/test-email/route.ts#POST" }
  ],
