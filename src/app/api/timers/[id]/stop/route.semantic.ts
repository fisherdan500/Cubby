...
export const semantic = [
  {
    "kind": "exposure",
    "ownerModule": "src/app/api/timers/[id]/stop/route.ts",
    "exportName": "POST",
    "binding": {
      "kind": "route_method",
      "symbol": "POST",
      "target": "src/app/api/timers/[id]/stop/route.ts#POST"
    },
    "serviceOperationIds": [
      "activity.timer.stop"
    ],
    "axes": {
      "carrier_authority_guard": {
        "current": {
          ...
          "sourceReferences": [
            {
              "kind": "symbol",
              "file": "src/app/api/timers/[id]/stop/route.ts",
              "exportName": "POST"
            }
          ]
        },
      ...
      "service_operation_linkage": {
        "current": {
          "authority": "source_reviewed",
          "value": "The route selects the direct stop service for mutation-receipt requests and the governed browser-submit timer operation for browser-operation requests.",
          "sourceReferences": [
            {
              "kind": "symbol",
              "file": "src/app/api/timers/[id]/stop/route.ts",
