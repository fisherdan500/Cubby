...
export const semantic = [
  {
    "kind": "exposure",
    "ownerModule": "src/app/api/timers/[id]/pause/route.ts",
    "exportName": "POST",
    "binding": {
      "kind": "route_method",
      "symbol": "POST",
      "target": "src/app/api/timers/[id]/pause/route.ts#POST"
    },
    "serviceOperationIds": [
    ...
    "axes": {
      "carrier_authority_guard": {
        "current": {
          ...
          "sourceReferences": [
            {
              "kind": "symbol",
              "file": "src/app/api/timers/[id]/pause/route.ts",
              "exportName": "POST"
            }
          ]
        },
      ...
      "service_operation_linkage": {
        "current": {
          "authority": "source_reviewed",
          "value": "The route selects the direct pause service for mutation-receipt requests and the governed browser-submit timer operation for browser-operation requests.",
          "sourceReferences": [
            {
              "kind": "symbol",
              "file": "src/app/api/timers/[id]/pause/route.ts",
