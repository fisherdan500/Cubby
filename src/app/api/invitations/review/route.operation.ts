...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/invitations/review/route.ts",
  ownerModule: "src/app/api/invitations/review/route.ts",
  ownerKind: "api_route",
  bindings: [{ kind: "route_method", symbol: "GET", target: "src/app/api/invitations/review/route.ts#GET" }],
