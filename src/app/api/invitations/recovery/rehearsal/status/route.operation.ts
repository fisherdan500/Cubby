...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/invitations/recovery/rehearsal/status/route.ts",
  ownerModule: "src/app/api/invitations/recovery/rehearsal/status/route.ts",
  ownerKind: "api_route",
  bindings: [{ kind: "route_method", symbol: "POST", target: "src/app/api/invitations/recovery/rehearsal/status/route.ts#POST" }],
