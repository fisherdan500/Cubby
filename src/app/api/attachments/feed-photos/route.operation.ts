...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/attachments/feed-photos/route.ts",
  ownerModule: "src/app/api/attachments/feed-photos/route.ts",
  ownerKind: "api_route",
  bindings: [
    {
      kind: "route_method",
      symbol: "POST",
      target: "src/app/api/attachments/feed-photos/route.ts#POST"
    }
  ],
