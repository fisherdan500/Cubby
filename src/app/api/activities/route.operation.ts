...
export const operation = {
  schemaVersion: 1,
  id: "api_route:src/app/api/activities/route.ts",
  ownerModule: "src/app/api/activities/route.ts",
  ownerKind: "api_route",
  bindings: [
    { kind: "route_method", symbol: "GET", target: "src/app/api/activities/route.ts#GET" },
    { kind: "route_method", symbol: "POST", target: "src/app/api/activities/route.ts#POST" }
  ],
